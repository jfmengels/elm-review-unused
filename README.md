...
- [🔧 `NoUnused.Patterns`](https://package.elm-lang.org/packages/jfmengels/elm-review-unused/1.2.6/NoUnused-Patterns/ "Provides automatic fixes") - Report useless patterns and pattern values that are not used.


- **(DEPRECATED)** [`NoUnused.Modules`](https://package.elm-lang.org/packages/jfmengels/elm-review-unused/1.2.6/NoUnused-Modules/ "Provides automatic fixes") - Reports unused modules in the project.
...
Thanks to @sparksp for writing [`NoUnused.Parameters`](https://package.elm-lang.org/packages/jfmengels/elm-review-unused/1.2.6/NoUnused-Parameters/)
and [`NoUnused.Patterns`](https://package.elm-lang.org/packages/jfmengels/elm-review-unused/1.2.6/NoUnused-Patterns/).
